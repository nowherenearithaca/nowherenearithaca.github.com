		...
		if ( elem.nodeType === 1 ) {
			...
			if ( (name in elem || elem[ name ] !== undefined) && notxml && !special ) {
				if ( set ) {
					...
					console.log("inside the if applicable if loop");
					if ( value === null ) {
						if ( elem.nodeType === 1 ) {
						...
						console.log("setting elem[" + name + "] = " + value);
						console.log(elem);
						console.log(elem[name]);//returning SVGAnimatedLength?
						console.log(value);
						elem[ name ] = value;
						console.log(elem[name]);//returning SVGAnimatedLength?
					}
				...
				console.log("about to return elem[ name ]");
			...
			if ( !jQuery.support.style && notxml && name === "style" ) {
				...
				console.log("about to return cssText");
